...
type StopData = { [stopRoute: string]: Bus[] }
...
type OCTranspoRoute = {
    ...
    Direction: string;
    DirectionID: number;
    Trips: { Trip: OCTranspoTrip[] | OCTranspoTrip } | OCTranspoTrip | OCTranspoTrip[] | undefined;                 // Object or list of objects
}
...
export {
    StopData, OCTranspoResponse, OCTranspoRoute, OCTranspoTrip
}