...
import { StopTimeModel } from 'api/models';
...
const nextStopTimes = async (stopTimeIDs: string[], find: number = 1, serviceLoader: DataLoader<string, Service>): Promise<StopTime[]> => {
    let day = currentDay();
